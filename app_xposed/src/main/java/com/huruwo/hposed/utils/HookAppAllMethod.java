...
public class HookAppAllMethod {
            ...
            XposedHelpers.findAndHookMethod(Application.class, "onCreate", new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                    ...
                    try {
                        ...
                        LogXUtils.e("hook class 成功" + hookclass.getName());
                    } catch (Exception e) {
                        LogXUtils.e("hook class 失败" + e.getMessage());
                        return;
                    }
    ...
    public static boolean dumpAllMethodInfo() {
        LogXUtils.e("all method size:" + methodSignSet.size());
        ...
        try {
            ...
            LogXUtils.e("dump all method error:" + Log.getStackTraceString(e));
            return false;
        } finally {
            try {
                if (fw != null) {
    ...
    public static boolean dumpCallMethodInfo() {
        LogXUtils.e("call method size:" + callMethodSignSet.size());
        ...
        try {
            ...
            LogXUtils.e("dump call method error:" + Log.getStackTraceString(e));
            return false;
        } finally {
            try {
                if (fw != null) {
